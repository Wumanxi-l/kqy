...
<head runat="server">
    ...
    <style>
        ...
        .navbar {
            background-color: #004080; /* 深蓝色导航栏 */
        }
...
<body>
    <form id="form1" runat="server">
        ...
        <div style="margin-bottom: 10px;">
            <div class="container">
                姓名：<asp:TextBox ID="TextBox1" runat="server" placeholder="输入姓名"></asp:TextBox>
                身份证号码：<asp:TextBox ID="TextBox2" runat="server" placeholder="输入身份证号码"></asp:TextBox>
                所属公司：<asp:DropDownList ID="DropDownList1" runat="server"></asp:DropDownList>
                <asp:Button ID="Button1" runat="server" Text="搜索" OnClick="Button1_Click" CssClass="btn_tj1" /></br>
                            ...
                            <ItemTemplate>
                                <a target="_blank" href="book_detail_view.aspx?bookid=<%#Eval("PerID") %>" class="module-pro-item fl">
                                    ...
                                    <div class="clearfix pro-item-bottom">
                                       ...
                                       <span class="text-color-9 fr align-center" style="color: #ff4e00;">库存：<%#Eval("Numbers") %></span>
                                    </div>
                                </a>
                            </ItemTemplate>
                        </asp:Repeater>
