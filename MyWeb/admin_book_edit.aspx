<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin_book_edit.aspx.cs" Inherits="admin_book_edit" %>
...
<body>
    <form id="form1" runat="server">
          <div class="m_right">
            <p></p>
            <div class="mem_tit">发布档案</div>
            <div class="m_des">

                         <div class="lab1">姓名：<asp:TextBox ID="txb_PerName" runat="server" CssClass="txb1"></asp:TextBox></div>
           </br>
            <div class="lab1">性别：  <asp:DropDownList ID="perSex" runat="server" CssClass="txb1"></asp:DropDownList></div>
           </br>               
          ...
          <div class="lab1">籍贯：<asp:TextBox ID="txb_address" runat="server" CssClass="txb1"></asp:TextBox></div>
           ...
           <div class="lab1">所属公司：<asp:DropDownList ID="dp_GongSi" runat="server" CssClass="dp" ></asp:DropDownList></div>
          </br>
          ...
          <div class="lab1">库存：<asp:TextBox ID="txb_num" runat="server" CssClass="txb1"></asp:TextBox></div>
                ...
                <asp:Button ID="Button1" runat="server" Text="修改" CssClass="btn_tj1" OnClick="Button1_Click" />
