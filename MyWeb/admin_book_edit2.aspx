<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin_book_edit2.aspx.cs" Inherits="admin_book_edit2" %>
...
<body>
 ...
 <div class="lab1">培训信息：<asp:Label ID="txb_Train" runat="server" CssClass="txb1"></asp:Label></div>
      ...
      <div class="lab1">照片：</div>
              ...
              <asp:Button ID="Button1" runat="server" Text="确认离职" CssClass="btn_tj1" OnClick="Button1_Click" />
