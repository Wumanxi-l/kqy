    ...
    <form id="form1" runat="server">
        <div class="container">
            <div class="login-container">
                ...
                <div class="form-group">
                    所属单位：<asp:DropDownList ID="DropDownList1" runat="server"></asp:DropDownList>
                </div>
                <div class="form-group">
                ...
                <asp:Button ID="Button1" runat="server" Text="注册" class="btn btn-primary" OnClick="Button1_Click" />
