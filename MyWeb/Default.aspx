...
<body>
    <form id="form1" runat="server">
        ...
        <div style="margin-bottom: 40px;">
            <div class="container">
                <div style="font-size: 23px; margin-left: 30px;">档案分区</div>
                </br>
                <div style="width: 1000px; margin-left: 80px;">
                    ...
                    <div class="clearfix">
                        <asp:Repeater ID="Repeater1" runat="server">
                            <ItemTemplate>
                                <a target="_blank" href="booktype.aspx?CategoryID=<%#Eval("CategoryID") %>" class="module-pro-item fl">
                                    <div class="pro-img">
                                        <img src="/UploadImg/<%#Eval("CateImg").ToString()%>" alt="">
                                    </div>

                                    <div class="clearfix pro-item-bottom">
                                        <p class="pro-price fl align-center"><%#Eval("CateName")%></p>
